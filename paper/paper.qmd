...
The DEXCAUS [@Federal_Reserve] dataset includes the daily exchange rate between USD and CAD (base USD = 1) from 1971-01-04 to\
2024-03-29 (date the dataset is downloaded for the purpose of the paper). Raw data contains only the date and the corresponding exchange rate of the day. Exchange rate in this dataset is used as the estimate of this paper.
