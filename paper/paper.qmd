...
knitr::kable(cleaned_inauguration, col.names = c("President", "Party", "Inauguration Date", "Change Party"), align = c("c", "c", "c", "c"))
```

### Construction of Inauguration Week
$$Day1 \hspace{5mm} Day2 \hspace{5mm}  Day3 \hspace{7mm}  \textbf{Inauguration Day} \hspace{7mm} Day5 \hspace{5mm} Day6 \hspace{5mm} Day7$$
```{r}
