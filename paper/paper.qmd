...
- small effect size causing low explanitory power
- inauguration dates does NOT include presidential announcement results where the previous president gets re-elected for the next season, will cause bias in estimation.
